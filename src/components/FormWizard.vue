    ...
    <div class="wizard-card-footer clearfix" v-if="!hideButtons">
      <slot name="footer"
        ...
        <div class="wizard-footer-left">
          <span @click.prevent="prevTab" @keyup.enter="prevTab" v-if="displayPrevButton" role="button">
        ...
        <div class="wizard-footer-right">
          ...
          <span @click.prevent="nextTab" @keyup.enter="nextTab" v-if="isLastStep" role="button">
          ...
          <span @click.prevent="nextTab" @keyup.enter="nextTab" role="button" v-else>
